...
@Component({
  ...
  imports: [RouterOutlet,RouterLink, MatToolbarModule, MatButtonModule, MatIconModule,
    MatSidenavModule, MatDividerModule, MatListModule, LanguageSwitcherComponent,AuthenticationSectionComponent],
...
export class AppComponent implements OnInit {
  ...
  options = [
    ...
    { icon: 'dashboard', path: '/requests', title: 'Requests'},
    { icon: 'dashboard', path:'/proposal', title: 'Proposals'},
